...
namespace com.mymooo.workbench.core.Expressage.DeBang
{
    ...
    public class DeBangClient
    {
        private readonly DeBangExpressageInfo _expressageInfo;

        public DeBangClient(IOptions<DeBangExpressageInfo> expressageInfos)
        {
        ...
        public string InvokeWebService(string method, string param)
        {
            ...
            string sign = Md5(param + _expressageInfo.AppKey + timestamp.ToString());

            httpWebRequest.ContentType = "application/x-www-form-urlencoded;charset=UTF-8";
            httpWebRequest.Method = "post";
            httpWebRequest.UserAgent = "kyySelection";
            param = $"companyCode={_expressageInfo.CompanyCode}&digest={sign}&timestamp={timestamp}&params={param}";
        ...
        public string Md5(string str)
        {
            ...
            return Convert.ToBase64String(Encoding.UTF8.GetBytes(req));
        }
