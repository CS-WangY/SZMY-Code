...
namespace Kingdee.Mymooo.Core.SalesManagement
{
    ...
    /// 退货通知单同步MES
    /// </summary>
    public class ReturnDeliveryToMesEntity
	{
		/// <summary>
		/// 表单ID
		/// </summary>
        ...
        /// 退货组织编码
        /// </summary>
        public string RetOrgCode { get; set; }
        /// <summary>
        /// 退货组织名称
        /// </summary>
        public string RetOrgName { get; set; }
        /// <summary>
        /// 客户ID
        /// </summary>
        ...
        /// 明细
        /// </summary>
        public List<ReturnDeliveryToMesDetEntity> Details { get; set; }
    }
    /// <summary>
    /// 明细
    /// </summary>
    public class ReturnDeliveryToMesDetEntity
    {
        /// <summary>
        /// 明细ID
        /// </summary>
