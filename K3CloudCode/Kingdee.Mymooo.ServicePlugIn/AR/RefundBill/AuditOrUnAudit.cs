...
namespace Kingdee.Mymooo.ServicePlugIn.AR.RefundBill
{
	[Description("退款单审核反审核插件"), HotUpdate]
...
,sales.FWECHATCODE SalesNumber,salesl.FNAME SalesName,0-r.FREFUNDTOTALAMOUNTFOR ReceiveAmount
...
where r.FID = @FID";
			var entryDatas = e.DataEntitys.Where(p => p.GetValue<string>("BillTypeID_Id", "") == "ef06f87d394a462d9f96cb2397803372").ToList();
