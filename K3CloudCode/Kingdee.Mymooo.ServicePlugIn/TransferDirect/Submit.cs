...
{
    [Description("直接调拨单提交插件"), HotUpdate]
    public class Submit : AbstractOperationServicePlugIn
    {
        ...
        //                    },
        //                    Remark = "仓库盘点",
        //                    LocCode = Convert.ToString(((DynamicObject)item["SrcStockId"])["Number"]),//仓库编号
        ...
        //                    },
        //                    Remark = "仓库盘点",
        //                    LocCode = Convert.ToString(((DynamicObject)item["DestStockId"])["Number"]),//仓库编号
