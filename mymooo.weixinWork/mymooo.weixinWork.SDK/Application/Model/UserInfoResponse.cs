...
namespace mymooo.weixinWork.SDK.Application.Model
{
    ...
    public class UserInfoResponse
    {
        ...
        public string Biz_Email { get; set; } = null!;
        ...
        /// <summary>
        /// 直属上级UserID，最多有五个直属上级；第三方仅通讯录应用可获取；对于非第三方创建的成员，第三方通讯录应用也不可获取；上游企业不可获取下游企业成员该字段
        /// </summary>
        ...
        /// </summary>
        public WeiXinUserExtattr? Extattr { get; set; }

        /// <summary>
        /// 用户扩展属性
        /// </summary>
        public class WeiXinUserExtattr
        {
            /// <summary>
            /// 扩展明细
            /// </summary>
            [JsonPropertyName("attrs")]
            public UserExtattrDetail[] ExtattrDetails { get; set; } = [];
        }

        /// <summary>
        /// 扩展明细
        /// </summary>
        public class UserExtattrDetail
        {
            /// <summary>
            /// 扩展属性名称
            /// </summary>
